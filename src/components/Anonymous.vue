<template>
  <div>
    <v-col class="demo-col demo-col-1" span="8" :style="{padding:'10px'}">
    ...
    <v-col class="demo-col demo-col-1" span="16" :style="{padding:'10px'}">
      <div class="msgBox">
          ...
          <ul>
            <li v-for="item in liData" :class="item.liClass"
              ...
              <div :style="{textAlign:'right'}">
                <a href="javascript:;" :style="{display:'block',right:'0'}" v-show="item.liClass"
                   @click="deleteLi(item)">删除</a>
              </div>
            </li>
